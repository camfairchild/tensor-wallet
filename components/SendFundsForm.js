...
const SendFundsForm = () => {
    ...
    return (_jsxs(React.Fragment, { children: [_jsxs(Stack, { direction: "column", spacing: 2, children: [_jsx(InputAddress, { setAddress: setAddress }), _jsx(InputFunds, { total: maxAmountFull, currency: unit, setAmount: setAmount })] }), _jsxs(Grid, { item: true, xs: 12, className: classes.infoRow, children: [_jsx(Structure, { fee: fee, name: "Fees", rest: fee ? `${prettyBalance(fee)} ${unit}` : "" }), _jsx(Structure, { fee: fee, name: "Balance after transaction", rest: fee
