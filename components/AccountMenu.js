...
export default function AccountMenu({ accounts }) {
    ...
    return (_jsxs(_Fragment, { children: [_jsx(IconButton, { onClick: handleClick, children: _jsx(ExpandMoreIcon, { style: { color: grey[500] } }) }), _jsxs(Menu, { transformOrigin: { vertical: -40, horizontal: "left" }, anchorEl: anchorEl, keepMounted: true, open: Boolean(anchorEl), onClose: () => setAnchorEl(null), className: classes.menu, children: [_jsx(ListItem, { dense: true, autoFocus: false, selected: false, children: _jsx(Typography, { variant: "overline", children: "Block explorers" }) }), _jsx(MenuItem, { onClick: () => openInNewTab(polkadotjsexplorerUri), children: "PolkadotJS Explorer" }), _jsx(BurnrDivider, {}), _jsx(ListItem, { dense: true, autoFocus: false, selected: false, children: _jsx(Typography, { variant: "overline", children: "Swtich Account" }) }), accounts?.map(({ address, meta }, index) => (_jsx(MenuItem, { onClick: () => setCurrentAccount({
