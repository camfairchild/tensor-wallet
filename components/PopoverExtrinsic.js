...
const PopoverExtrinsic = ({ status, blockHash, }) => {
    ...
    return (_jsxs(_Fragment, { children: [_jsxs(IconButton, { onMouseEnter: handlePopoverOpen, onMouseLeave: handlePopoverClose, onClick: handleClick, children: [status === 0 && _jsx(CachedIcon, { color: "disabled" }), status === 1 && _jsx(CheckIcon, { color: "action" }), status === 2 && _jsx(ErrorIcon, { color: "error" }), status === 3 && _jsx(CircularProgress, {})] }), _jsx(Popover, { elevation: 2, transitionDuration: 0, id: "mouse-over-popover", className: classes.popover, classes: {
                    ...
                    vertical: "bottom",
                    horizontal: "center",
                }, onClose: handlePopoverClose, disableRestoreFocus: true, children: blockHash ? (_jsx(Typography, { variant: "body2", children: "View on Explorer" })) : (_jsx(Typography, { variant: "body2", children: "Pending" })) })] }));
};
