...
export default function StakeForm({ hotkeyAddr, stake, refreshMeta }) {
    ...
    return (_jsxs(React.Fragment, { children: [_jsxs(Stack, { direction: "row", spacing: 2, alignItems: "center", justifyContent: "center", paddingY: 2, children: [_jsx(ErrorBoundary, { children: _jsx(InputFunds, { total: maxAmountFull, currency: unit, setAmount: setAmount }) }), _jsxs(ButtonGroup, { variant: "contained", "aria-label": "outlined primary button group", children: [_jsx(Button, { type: "submit", variant: "contained", size: "medium", color: "primary", disabled: loading ||
                                    ...
                                    (!parseInt(amount) || parseInt(amount) === 0) ||
                                    fundsIssueUnstake, onClick: handleUnstake, className: classes.button, children: "Unstake" })] })] }), _jsx(Typography, { variant: "body2", color: "error", className: classes.errorMessage, children: errorMsg }), message &&
