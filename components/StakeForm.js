...
import { makeStyles, Typography, LinearProgress, Table, Box, } from "@material-ui/core";
...
export default function StakeForm({ hotkeyAddr, stake, refreshStake }) {
    ...
    return (_jsxs(React.Fragment, { children: [_jsxs(Stack, { direction: "row", spacing: 2, alignItems: "flex-start", justifyContent: "center", children: [_jsx(InputFunds, { hidePercentages: true, total: maxAmountFull, currency: unit, setAmount: setAmount, showValue: showValue, setShowValue: setShowValue }), _jsxs(ButtonGroup, { variant: "contained", "aria-label": "outlined primary button group", children: [_jsx(Button, { type: "submit", variant: "contained", size: "medium", color: "primary", disabled: loading ||
                ...
                _jsxs(Box, { mt: 3, children: [countdownNo !== 0 && (_jsx(Table, { size: "small", children: _jsx(HistoryTableRow, { row: {
                                    withWhom: hotkeyAddr,
                                    value: amount,
                                    status: rowStatus,
